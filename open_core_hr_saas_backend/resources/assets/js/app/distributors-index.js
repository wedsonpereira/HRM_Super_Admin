$(function () {
  var dt_table = $('.datatables-distributors');
  ...
  if (dt_table.length) {
    var dt_distributors = dt_table.DataTable({
      processing: true,
      serverSide: true,
      ajax: {
        url: baseUrl + 'distributors/getListAjax',
      ...
      columnDefs: [
...

        {
         //phone number
          ...
          className: 'text-start',
          render: function (data, type, full, meta) {
            return '<span class="phone_number">' + full['phone_number'] + '</span>';
          }
        },
        {
          // email
...

        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<a href="distributors/show/${full['id']}" class="btn btn-sm btn-icon info-record">
                   <i class="bx bx-show"></i>
                  </a>` +
              `<a href="distributors/edit/${full['id']}" class="btn btn-sm btn-icon edit-record">
  ...
  function deleteDistributor(id) {
    $.ajax({
      url: `distributors/deleteAjax/${id}`,
      type: 'DELETE',
  ...
  $(document).on('change', '.status-toggle', function () {
    ...
    $.ajax({
      url: `${baseUrl}distributors/changeStatusAjax/${id}`,
      type: 'POST',
      data: {
        status: status,
