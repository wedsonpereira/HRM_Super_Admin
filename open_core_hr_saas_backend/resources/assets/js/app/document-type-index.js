...
$(function () {
  ...
  if (dt_table.length) {
    var dt_proofType = dt_table.DataTable({
...

        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              `<button class="btn btn-sm btn-icon edit-record" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddOrUpdateProofType"><i class="bx bx-edit"></i></button>` +
      ...
      language: {
        sLengthMenu: '_MENU_',
        search: '',
        searchPlaceholder: 'Search Proof Type',
  ...
  var offCanvasForm = $('#offcanvasAddOrUpdateProofType');

  $(document).on('click', '.add-new', function () {
    $('#id').val('');
    $('#notes').val('');
    $('#offcanvasProofTypeLabel').html('Add Proof Type');
    fv.resetForm(true);
    setCode();
  });
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $('#offcanvasProofTypeLabel').html('Edit Proof Type');
    ...
    $.get(`${baseUrl}documentTypes\/getByIdAjax\/${id}`, function (response) {
      ...
      $('#isProofRequiredToggle').prop('checked', !!data.isRequired);
    });
  });
