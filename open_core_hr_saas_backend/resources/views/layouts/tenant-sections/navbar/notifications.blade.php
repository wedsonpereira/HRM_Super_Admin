@php
  $notifications = \App\Models\UserNotification::where('user_id', auth()->id())->orderBy('created_at', 'desc')->get();
          ...
          <li
            ...
            <div class="d-flex">
              ...
              <div class="flex-grow-1">
                ...
                <small class="mb-1 d-block text-body">{{$notification->notification->message}}</small>
